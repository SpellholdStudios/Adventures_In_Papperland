...
:warning: **The maintenance and support of this project has been moved to a [new repository](https://github.com/Spellhold-Studios/Adventures-in-Papperland).**

<hr><br>

![Latest Release](https://img.shields.io/github/v/release/SpellholdStudios/Adventures_In_Papperland?include_prereleases&color=darkred)<a name="top" id="top">
...
[Download the mod at Spellhold Studios](http://www.shsforums.net/files/file/139-adventures-in-papperland/)<br>
...
###### This little mod was created as a joke.
...
*If you've previously installed the mod, remove it before extracting the new version. To do this, run **`setup-aip.exe`**, un-install all previously installed components and delete the :file_folder: **aip** folder.*
...
Adventures in Papperland for Windows is distributed as an extractable compressed archive and includes a WeiDU installer.

Extract the contents of the mod archive into the folder of the game you wish to modify (*the folder which contains the "CHITIN.KEY" file*), using <a href="http://www.7-zip.org/download.html">7zip</a>, <a href="http://www.rarlab.com/download.htm">WinRAR</a>, or another file compression utility that handles .zip files. On successful extraction, there should be a :file_folder: aip folder and a setup-aip.exe file in your game folder. To install, simply double-click **`setup-aip.exe`** and follow the instructions on screen.

Run **`setup-aip.exe`** in your game folder to reinstall, un-install or otherwise change the components settings.

## 

#### Mac OS X

Adventures in Papperland for Mac OS X is distributed is distributed in the same compressed archive and includes a WeiDU installer.

First, extract the files from the archive into your game directory. On successful extraction, there should be a :file_folder: aip folder, setup-aip and setup-aip.command files in your game folder. To install, simply double-click **`setup-aip.command`** and follow the instructions on screen.

Run **`setup-aip.command`** in your game folder to reinstall, un-install or otherwise change the components settings.

## 

#### Linux

Adventures in Papperland for Linux is distributed as a compressed tarball and does not include a WeiDU installer.
...
To install, run **`WeInstall setup-aip`** in your game folder. Then run **`wine BGMain.exe`** and start playing.

## 

#### Note for Complete Un-installation

In addition to the methods above for removing individual components, you can completely un-install the mod using **`setup-aip --uninstall`** at the command line to remove all components without wading through prompts.</br>
<div align="right"><a href="#top">Back to top</a></div>
...
- Updated, renamed readme file to "*aip-readme.txt*" and moved it into new "*readme*" folder.
...
- Added `VERSION` flag.
- Corrected the wrong German translator name.
...
- Added German translation by Drogan Di'Umptu (thank you!!!)..
